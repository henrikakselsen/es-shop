...
*/
$rayne_attch_image = wp_get_attachment_image(get_the_ID(), 'large');
$rayne_attch_url = wp_get_attachment_url( get_the_ID());

if ($rayne_attch_image) {
	echo $rayne_attch_image;
} else { ?>

	<a href="<?php echo esc_url($rayne_attch_url); ?>"><?php echo esc_url($rayne_attch_url); ?></a> 
