		...
		<footer id="footer" class="footer-site">
			...
			<div <?php layers_wrapper_class( 'footer_widgets', 'bgl-footer-widgets' ); ?>>
			...
			<div <?php layers_wrapper_class( 'footer_site', 'bgl-footer-copyright' ); ?>>
				<div class="<?php if( 'layout-fullwidth' != layers_get_theme_mod( 'footer-width' ) ) echo 'container'; ?>  clearfix">
					...
					<div class="row copyright">
						...
						<?php } ?>
						<div class="column span-6 clearfix t-right footer-menu-bgls">
